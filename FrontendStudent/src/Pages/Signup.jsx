...
import { Eye, EyeOff, Mail, Lock, User, BookOpen, GraduationCap, Hash, Layers, Users, Search, ChevronDown } from "lucide-react";
...
export default function Signup() {
  ...
  // Available specializations based on selected course
          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-gray-600">
                Join thousands of students and teachers using AI-powered
                learning tools
              </p>
            </div>

            <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-3xl p-8 text-white shadow-xl">
              <h3 className="text-xl font-bold mb-6">Why Join ADHYAN.AI?</h3>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-purple-100">
                      Smart organization and summaries
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
        ...
        <div className="w-full">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Student-specific fields — only shown when role=student */}
              {formData.role === "student" && (
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          // If the user clears, also clear formData.course
                          if (!e.target.value) {
                            setFormData({ ...formData, course: "", specialization: "" });
                          }
                        }}
