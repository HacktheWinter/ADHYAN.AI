...
export default function AssignmentResultModal({
  ...
  const {
    ...
    queryKey: ["assignmentResult", assignmentId, studentId],
    queryFn: fetchAssignmentResult,
    enabled: !!assignmentId && !!studentId, //important
    onSuccess: () => {
      setSelectedIndex(0);
      answerRefs.current = [];
    },
      ...
      <div className="bg-white w-full h-full max-w-none rounded-none flex flex-col">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <main className="flex-1 overflow-y-auto p-6">
            ...
            {result.submissionType === 'pdf' && result.pdfFileId && (
              <div className="mb-8 p-6 bg-purple-50 rounded-xl border border-purple-100 flex items-center justify-between">
                <div>
                ...
                <button
                  onClick={() => window.open(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api'}/assignment-submission/pdf/${result._id}`, "_blank")}
            ...
            <div className="space-y-6">
              {result.answers.map((answer, index) => {
                const marksPercentage =
                  (answer.marksAwarded / answer.marks) * 100;
                return (
                  <div
