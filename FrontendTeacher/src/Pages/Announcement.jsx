        ...
        if (isImage) {
            return (
                <div className="mt-2 relative group max-w-sm cursor-pointer" onClick={() => setPreviewFile({ url, type: 'image', name: fileName })}>
                    <img src={url} alt="Attachment" className="rounded-lg border border-gray-200 object-cover max-h-60 w-full sm:w-auto" />
                </div>
            );
        }
            ...
            >
                <div className="p-1.5 sm:p-2 bg-white rounded-md border border-gray-100 shadow-sm flex-shrink-0">
                 ...
                 <div className="flex-1 min-w-0">
                    <p className="text-xs sm:text-sm font-medium text-gray-700 truncate">{fileName || "Attachment"}</p>
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
                <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 text-xs sm:text-sm">Manage updates for your class</p>
                    </div>
                </div>
             ...
             {loading ? (
                ...
                <div className="space-y-4 sm:space-y-6 max-w-4xl mx-auto">
                    ...
                    <div className="text-center py-12 sm:py-16 bg-white rounded-2xl border border-gray-100 shadow-sm">
                        ...
                        <h3 className="text-base sm:text-lg font-semibold text-gray-900">No announcements yet</h3>
                        <p className="text-sm sm:text-base text-gray-500 mt-1 px-4">Click the button above to post your first update</p>
                    </div>
                    ) : (
                        announcements.map((announcement) => (
                            ...
                            <div className="p-4 sm:p-6">
                                ...
                                <div className="flex items-center gap-2 sm:gap-3">
                                    ...
                                    <div>
                                    <h4 className="font-semibold text-gray-900 text-sm sm:text-base">{announcement.teacherId?.name || "Teacher"}</h4>
                                ...
                                >
                                    {deleting === announcement._id ? <Loader className="w-4 h-4 animate-spin"/> : <Trash2 className="w-4 h-4" />}
                                </button>
                                </div>

                                <div className="sm:pl-[52px]">
                                    <p className="text-gray-700 whitespace-pre-wrap leading-relaxed text-sm sm:text-base">{announcement.message}</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60">
            <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl transform transition-all scale-100 overflow-hidden max-h-[90vh] flex flex-col">
                <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50 flex-shrink-0">
                    <h2 className="text-lg sm:text-xl font-semibold text-gray-800">New Announcement</h2>
                    <button 
                ...
                <form onSubmit={handlePost} className="p-4 sm:p-6 flex-1 overflow-y-auto">
                    <div className="mb-4">
                        <textarea
                            value={message}
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-4 border-t border-gray-100 mt-2">
                        <div className="flex items-center gap-2">
                            ...
                            >
                                ...
                                <span className="text-xs sm:text-sm font-medium">Attach File</span>
                            </label>
                        </div>
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <button
                                ...
                                className="flex-1 sm:flex-none px-6 py-2 bg-gray-200 text-gray-500 font-semibold rounded-lg hover:bg-purple-600 hover:text-white disabled:opacity-50 disabled:hover:bg-gray-200 disabled:hover:text-gray-500 transition-all cursor-pointer text-sm sm:text-base"
                                style={{ minWidth: '80px' }}
                            >
                                {creating ? <Loader className="w-4 h-4 animate-spin mx-auto"/> : "Post"}
                            </button>
                        </div>
                    </div>
                </form>
       ...
       {previewFile && (
           previewFile.type === 'pdf' ? (
                ...
                <div className="fixed inset-0 bg-black/90 z-[100] flex items-center justify-center p-4" onClick={() => setPreviewFile(null)}>
                    <div className="relative max-w-5xl w-full max-h-[90vh] flex flex-col items-center">
                        ...
                        <img 
                            ...
                            onClick={(e) => e.stopPropagation()}
                        />
                        <p className="text-white/80 mt-4 font-medium text-sm sm:text-base px-4 text-center">{previewFile.name}</p>
                    </div>
                </div>
           )
       )}
